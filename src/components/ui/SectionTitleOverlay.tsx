...
export default function SectionTitleOverlay({ title, scrollYProgress }: SectionTitleOverlayProps) {
  ...
  // Blur decreases to 0, then stays
  ...
  return (
    ...
    >
      <h2 
        className="font-futuraBold text-[15vw] md:text-[12vw] uppercase tracking-[0.2em] whitespace-nowrap text-white drop-shadow-[0_0_30px_rgba(255,255,255,0.4)]"
      >
        {title}
      </h2>
    </motion.div>
